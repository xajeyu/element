...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'nokia-element/src/utils/date-util';
  import { hasClass } from 'nokia-element/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'nokia-element/src/utils/util';
