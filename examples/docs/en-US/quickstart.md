...
```javascript
import Vue from 'vue';
import ElementUI from 'nokia-element';
import 'nokia-element/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'nokia-element';
import App from './App.vue';
...
```js
import Vue from 'vue';
import Element from 'nokia-element';
...
```js
import Vue from 'vue';
import { Button } from 'nokia-element';
